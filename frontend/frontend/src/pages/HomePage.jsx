    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="pt-20 pb-20 px-4 flex flex-col items-center text-center">
                {/* Lightly transparent box for hero text */}
                <div className="bg-black/60 text-white p-8 rounded max-w-2xl">
                    ...
                    <p className="text-xl mb-8">
                        Build your perfect trip with flights, hotels, and activities tailored
                        to your preferences.
                    </p>
                    <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0 justify-center">
                        <Link
                            to="/create-itinerary"
                            className="bg-[var(--color-primary)] hover:bg-[var(--color-secondary)] text-white font-bold py-3 px-6 rounded"
                        >
                            Start Building
                        </Link>
                        <Link
                            to="/login"
                            className="bg-white hover:bg-gray-200 text-[var(--color-primary)] font-bold py-3 px-6 rounded"
                        >
                            Login / Register
                        </Link>
                    </div>
            ...
            {/* How It Works - transparent boxes */}
